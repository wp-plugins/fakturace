...
class GopaySoap {
  ...
  public static function isPaymentDoneWCust($paymentSessionId,
	 ...
	 * @param string $secureKey - kryptovaci klic prideleny GoPay
	 */
	public static function voidRecurrentPayment($paymentSessionId,
										$targetGoId,
										$secureKey) {
	 ...
	 * @param string $secureKey - kryptovaci klic prideleny GoPay
	 */
	public static function performRecurrence($parentPaymentSessionId,
	 ...
	 * @param string $secureKey - kryptovaci klic prideleny GoPay
	 */
	public static function capturePayment($paymentSessionId,
						  		$targetGoId,
								$secureKey) {
		try {
	 ...
	 * @param string $secureKey - kryptovaci klic prideleny GoPay
	 */
	public static function refundPayment($paymentSessionId,
						  		$targetGoId,
								$secureKey) {
		try {
	...
	* @param string $secureKey - kryptovaci klic prideleny GoPay
	*/
	public static function refundPaymentPartially($paymentSessionId,
											$amount, 
											$currency,
											$description,
				  							$targetGoId,
